...
The page hosts the partitions created by each one of algorithms in our comparison set of community detection algorithms.
...
![Fig. 1 of the paper](Images/Fig_icon_stats_v2_406_v2.pdf)
